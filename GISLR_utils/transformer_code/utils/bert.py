...
from transformers.models.bert.modeling_bert import BertAttention, BertIntermediate, BertOutput, apply_chunking_to_forward, BaseModelOutputWithPastAndCrossAttentions, logging

logger = logging.get_logger(__name__)

class BertEncoderCPE(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.layer = nn.ModuleList([BertLayerCPE(config, _) for _ in range(config.num_hidden_layers)])
